sap.ui.jsview("enterPasscode", {
    ...
    createContent: function(oController) {
            ...
            var inputPassword = new sap.m.Input( 'Password_item', {
                ...
                placeholder:formatString(getLocalizedString("SCR_ENTER_PASSCODE_INSTRUCTIONS"), appName),
                liveChange:function() {
            ...
            var confirmMaxRetriesText = new sap.m.Text('max_retries_text',{
                text:formatString(getLocalizedString("SCR_ENTER_PASSCODE_MAX_RETRY_CONFIRM"), appName)
            });
