cordova.define("kapsel-plugin-logon.Logon", function(require, exports, module) {     var utils = sap.logon.Utils;
    var TIMEOUT = 2000;
        ...
        */
        ...
        var onOAuthEvent = function (url) {
            ...
            var continueAfterOAuth = function () {
                 startLogonCoreRegistration(onRegSucceeded, function (error) { onRegErrorNoPreviousWindow(error); }, _providedContext);
            };
    ...
    var sendOAuthPingRequest = function (serverHost, serverProtocol, serverPort, applicationId, appCid, aToken, user, password, onsuccess, onerror) {
        ...
        pingUrl += "/odata/applications/v2/" + applicationId + "/Connections('" + appCid + "')";
        ...
        sap.Logon.core.getSecureStoreObject(function (endpoint) {
            ...
            sap.Logon.core.getSecureStoreObject(function (token) {
                ...
                sap.AuthProxy.sendRequest("POST", tEndpoint, headers, body,
                    function (result) {
                                          console.log("****[TR]: " + JSON.stringify(result));
                        // success
                        if (result.status == 200 && result.responseText) {
                            ...
                            console.log("Error at the token request!");
                                          ...
                                          console.log("****[TR]: " + JSON.stringify(error));
                        // error
