cordova.define("kapsel-plugin-logon.LogonJsView", function(require, exports, module) {     var utils = sap.logon.Utils;
        ...
        if (screenId == "SCR_SAML_AUTH"){
            ...
            return;
                ...
                var sendPingRequest = function (context, token) {
                    ...
                    pingUrl += "/odata/applications/v2/" + sap.Logon.applicationId + "/Connections";
